...
void addToList(int y, int x, int n) {
  ...
  if (y-1>=0 && x+2<3 && 48<line[y-1][x+2] && line[y-1][x+2]<53) {add(y-1,x+1,n);}
  if (y+1<n && x+2<3 && 48<line[y+1][x+2] && line[y+1][x+2]<53) {add(y+1,x+1,n);}
}
